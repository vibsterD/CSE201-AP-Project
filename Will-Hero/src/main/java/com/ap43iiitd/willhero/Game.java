...
public class Game implements Serializable {
    ...
    public Game(AnchorPane game_screen, Rectangle sword, Rectangle shuriken, StackPane game_pane, Label coins_counter) {
        populateScreen(game_screen, sword, shuriken, game_pane, coins_counter);
...
//        System.out.println(this.currentScore+"BIBNIBIBI");
    ...
    public void play() {
        ...
        collisionMan = new Timeline(new KeyFrame(Duration.millis(5), event -> resolveCollision()));
...
//                System.out.println("OPACITY 0");
    ...
    public void gameOver() {
        ...
        if (hero.hasRespawned() || hero.getCoins() < 50) {
            ...
            byeTrans.setOnFinished(ev -> sceneSwitcher("EnterMenuOverlay.fxml"));
            byeTrans.play();
            //game is really over
        } else {
...
//        System.out.println("CREATING Cloud");
    ...
    private void populateScreen(AnchorPane game_screen, Rectangle sword, Rectangle shuriken, StackPane game_pane, Label coins_counter) {
    ...
    private void saveGame(PauseMenuOverlay pmo) {
